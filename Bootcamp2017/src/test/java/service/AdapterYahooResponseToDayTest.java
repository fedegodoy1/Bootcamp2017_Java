...
//        JsonNode jsonMock = EasyMock.createMock(JsonNode.class);
        ...
        assertEquals("Cordoba",dayResponse.getLocation().getCity());
        assertEquals("Argentina",dayResponse.getLocation().getCountry());
